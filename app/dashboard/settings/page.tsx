...
export default function SettingsPage() {
  ...
  const handleCreateWorkspace = async () => {
    if (!settings.workspace.name.trim()) return
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (switchResponse.ok) {
          console.log(`Workspace ${settings.workspace.name} created successfully`)
          ...
          <Card className="glass-panel border-cyan-500/20">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">
                Manage your workspace configuration and member access
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button 
                  ...
                  disabled={!settings.workspace.name.trim() || creatingWorkspace}
                  className="command-button"
                >
              ...
              {/* Member Management - Merged from Role Management */}
